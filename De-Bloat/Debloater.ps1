...
$zipUrl = "https://github.com/dxmnoc/script/releases/download/v1.0-fixed/RemoveBloat.zip"
...
# --- CUSTOMIZE YOUR WHITELIST HERE ---
# Define the apps you want to keep in this array for easy editing.
$whiteListArray = @(
    "7-Zip 24.09 (x64)",
    "AutoHotkey (user)",
    "Carbon Black Cloud Sensor 64-bit",
    "Dell Digital Delivery Services",
    "Dell Trusted Device Agent",
    "Fellow",
    "FortiClient",
    "KeeperSecurityInc.KeeperPasswordManager",
    "Logitech Gaming Software 9.04",
    "Microsoft Edge",
    ...
    "Microsoft.Notepad", # This is an older name for Notepad; keeping both is safe.
    "Microsoft.ScreenSketch"
)

# This next line automatically builds the argument string from the array above.
# You do not need to edit this line.
$arguments = " -customwhitelist ""$($whiteListArray -join ',')"""
